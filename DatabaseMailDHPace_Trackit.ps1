		@email_address=N'DL-Aclara-DB-Admins@hubbell.com', 
		@display_name=N'SQL Alert - HI', 
		@replyto_address=N'DL-Aclara-DB-Admins@hubbell.com', 
		@description=N'Mail account for administrative e-mail.'

# Step 1 - Set variables for mail options. 
  $sqlServer = 'co1-trackit-d-1'
  $accountName = 'dbMailDefaultAcct'
  $accountDescription = 'Default dbMail Account'
  $originatingAddress = "$sqlServer@lss.org"
  $replyToAddress = 'DO_NOT_REPLY@lss.org'
  $smtpServer = 'smtp.lss.org'
